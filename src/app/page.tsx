    ...
    <main className="min-h-screen">
      <section className="relative h-[600] overflow-hidden  ">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-white text-center  ">
          <h1 className="text-4xl  md:6xl font-bold mb-8 ">
            Buy and Sell Old Books Online in India
          </h1>
          <div className="flex flex-col sm:flex-row gap-6 ">
            <Button
              size="lg"
              className="group bg-gradient-to-r from-blue-600 to-blue-700 hover:to-blue-800 text-white px-8 py-6 rounded-xl "
            >
              <div className="flex items-center gap-3 ">
                <div className="bg-white/20 rounded-lg group-hover:bg-white/30 transition-colors ">
                  <ShoppingBag className="h-6 w-6" />
                </div>
                <Link className="" href="/books">
                  <div className="text-left">
                    <div className="text-sm opacity-90">Start Shopping</div>
                    <div className="font-semibold ">By used Book</div>
                  </div>
                </Link>
              </div>
            </Button>
            <Button
              size="lg"
              className="group bg-gradient-to-r from-yellow-500 to-yellow-700 hover:to-yellow-800 text-white px-8 py-6 rounded-xl "
            >
              <div className="flex items-center gap-3 ">
                <div className="bg-white/20 rounded-lg group-hover:bg-white/30 transition-colors ">
                  <ShoppingBag className="h-6 w-6" />
                </div>
                <Link className="" href="/booksell">
                  <div className="text-left">
      ...
      >
        <Link className="" href="/books">
          <div className="text-sm">Explor All books</div>
        </Link>
      </Button>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-4">
            <h2 className="text-3xl font-bold mb-4 ">
            How to BUY second hand books online on BookKar?
            </h2>
            <p className="text-gray-600 mx-w-2xl mx-auto ">
      ...
      <section className="py-16 bg-[rgb(221,234,254)]">
       <div className="container mx-auto px-4  ">
        <h2 className="text-3xl font-bold text-center mb-12">Read form Our <span className="text-primary ">Blog</span></h2>
         ...
         <Card key={index} className="h-full flex flex-col overflow-hidden  transition-all duration-300 hover:shadow-lg ">
          <CardContent className="p-0 flex flex-col h-full">
            <div className="relative h-48 overflow-hidden">
              <Image src={post.imageSrc} alt="img" layout="fill" objectFit="cover" className="transition-transform duration-300 hover:scale-105"></Image>
            </div>
            <div className="p-6 flex flex-cal flex-grow ">
              <h3 className="text-xl font-semibold flex items-center gap-2  ">
                <div className="bg-primary/10 p-2 rounded-2  ">{post.icon}</div>
                <span className="flex-grow ">{post.title}</span>
              </h3>
              
            </div>
            <p className="p-6 text-gray-600 text-sm flex-grow ">{post.description}</p>
            <Button variant='link' className="mt-4 p-0 flex items-center text-primary">Read more <ArrowRight className="w-4 h-4" ></ArrowRight></Button>
          </CardContent>
         </Card>
        ))}
       </div>
