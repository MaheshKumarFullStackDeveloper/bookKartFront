...
export namespace Prisma {
  ...
  */
    ...
    model: {
      snippets: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.snippetsFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.snippetsAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type snippetsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "code", ExtArgs["result"]["snippets"]>
  ...
  export interface snippetsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Snippets that matches the filter.
     * @param {snippetsFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const snippets = await prisma.snippets.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: snippetsFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Snippets.
     * @param {snippetsAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const snippets = await prisma.snippets.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: snippetsAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
   ...
   * snippets findRaw
   */
  export type snippetsFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * snippets aggregateRaw
   */
  export type snippetsAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type snippetsWhereInput = {
    ...
    code?: StringFilter<"snippets"> | string
  }
  ...
  export type snippetsScalarWhereWithAggregatesInput = {
    ...
    code?: StringWithAggregatesFilter<"snippets"> | string
  }
